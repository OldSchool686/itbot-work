...
Чат-бот для автоматизации IT-поддержки сотрудников компании. Интеграция с Bitrix24, RAG на базе локальной LLM, веб-панель администратора и мобильное приложение с push-уведомлениями.
...
8. Если включён RAG → бот ищет похожие решения:
